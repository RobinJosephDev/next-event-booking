...
const RegisterPage = ()=>{
    ...
    const handleRegister = async (e)=>{
        e.preventDefault();
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/api/auth/register`, {
            method: "POST",
            headers: {
...
_s(RegisterPage, "K1M20/Y1875flEo0hV7hQKCWv4k=", false, function() {
    return [
